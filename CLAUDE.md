...
**Branch `deck-redevelopment`.** Day 1 is **129 slides**, Day 2 **146**, from 88 + 92 outline
...
`REVIEW.md` row** — `python3 tools/deck_index.py <day>` is the truth. Day 2's 146 includes **four
