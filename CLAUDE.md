...
**Branch `deck-redevelopment`.** Day 1 is **129 slides**, Day 2 **143**, from 88 + 92 outline
...
`REVIEW.md` row** — `python3 tools/deck_index.py <day>` is the truth. Day 2's 143 includes **four
