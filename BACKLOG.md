...
**143**; **104 figures** across twelve families plus **2 print cards** — **89 on slides**, **9 in the two
handouts**, 4 Paper Flow exercise materials, and **2 placed nowhere** (`conversation-timeout`,
`paper-the-desk`) — lint clean, `reads_at` **30 of 104**, and speaker notes ship into both `.pptx`.
**Day 1's figures sit at a median 87% of their Phase 2 label size, Day 2 at 96% with five under 85%** —
